...
const ALLOWED_ORIGINS = [
  "https://himelhossain.lovable.app",
  "https://id-preview--81a79163-a9e7-4c8e-b963-feae3930d7da.lovable.app",
];
...
serve(async (req) => {
  ...
  try {
    ...
    if (!messages.every((m) => ["user", "assistant"].includes(m?.role) && typeof m?.content === "string")) {
